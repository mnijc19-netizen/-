...
async function run() {
  ...
  await page.screenshot({ path: 'd:/Antigravity项目/财务管理系统/deployed_modal_screenshot.png' });

  // Test mobile view
  await page.setViewport({ width: 375, height: 812 });
  await new Promise(r => setTimeout(r, 500));
  await page.screenshot({ path: 'd:/Antigravity项目/财务管理系统/deployed_mobile_screenshot.png' });
  ...
  await new Promise(r => setTimeout(r, 500));
  await page.screenshot({ path: 'd:/Antigravity项目/财务管理系统/deployed_dark_screenshot.png' });
