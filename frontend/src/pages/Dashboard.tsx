...
export const Dashboard: React.FC<DashboardProps> = ({
  ...
  return (
    <div className="space-y-3.5 pb-32 animate-in fade-in duration-200 max-w-lg mx-auto">
      ...
      {/* 2. Customizable Horizontal Financial Modular Widgets (Debts, Budgets, Goals, Planner, Investments, Analytics) */}
      <DashboardModularWidgets privacyMode={privacyMode} onNavigateTo={onNavigateTo} />
