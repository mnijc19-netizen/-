        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          ...
          <div className="pt-3 flex items-center justify-end gap-3">
            ...
            <button
              type="submit"
              disabled={saving}
              className="px-6 py-2.5 rounded-xl bg-emerald-600 hover:bg-emerald-500 text-white text-xs font-bold shadow-lg shadow-emerald-500/20 flex items-center gap-1.5 transition active:scale-95"
            >
              {saving ? '保存中...' : '确认记录'}
